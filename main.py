...
# Path configurations
PLAYER_DETECTION_MODEL_PATH = r"player_detection_model.pt"
PITCH_DETECTION_MODEL_PATH = r"pitch_keypoint_tracker.pt"
BALL_DETECTION_MODEL_PATH = r"ball_detection_model.pt"
...
if __name__ == '__main__':
    source_video_path = r"source_video_path.mp4"
    target_video_path = rf"target_video_path.mp4"
    csv_output_path = r"CSV_result_path.csv"                # for visualization of tracking data
